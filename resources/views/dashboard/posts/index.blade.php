...
@section('container')
 <h1 class="font-bold text-center mt-4">My Posts</h1>
 ...
 <!-- component -->
    ...
    <div class="container mt-4 mx-auto px-4">
        ...
        <a href="/dashboard/posts/create" class="bg-blue-500 p-2 rounded-lg mb-4 text-white shadow-lg font-semibold">Create new posts</a>
                        ...
                        <tbody>
                           @foreach ($posts as $post)
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <a href="/dashboard/posts/{{ $post->slug }}" class="text-gray-900 whitespace-no-wrap ">
                                       <span
                                    ...
                                    <a href="/dashboard/posts/{{ $post->slug }}/edit" class="text-gray-900 whitespace-no-wrap">
                                       <span
