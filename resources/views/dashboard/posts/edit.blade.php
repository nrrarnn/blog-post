...
@section('container')
     <h1 class="font-bold text-center mt-4">Edit Post</h1>
                    ...
                    <div class="mx-auto max-w-lg">
                        ...
                        <div class="py-1">
                            <span class="block text-sm font-medium text-gray-700">Slug</span>
                                <input placeholder="" type="text" class="text-md block px-3 py-2 rounded-lg w-full bg-white border border-gray-300 placeholder-slate-900 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-300 focus:outline-none @error('slug') border-red-300 @enderror" id="slug" name="slug" required value="{{ old('slug', $post->slug) }}">
                                @error('slug')
								<p class="text-red-500 text-sm">
									{{ $message }}
								</p>
                        ...
                        <div class="py-1 ">
                         ...
                         <form class="flex items-center space-x-6">
                            ...
                            <label class="block">
                                ...
                                @if($post->image)
                                    <img src="{{ asset('storage/' . $post->image) }}" class="img-preview w-1/3 mt-3">
                                @else
